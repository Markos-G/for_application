    ...
    internal class VendingMachine: IVendingMachine
    {
        ...
        static void Main(string[] args)
        {
            ...
            if (File.Exists(dbFileSnacks))
            {
                ...
                snacks = JsonConvert.DeserializeObject<Snack>(jsonSnacks);
            }
            ...
            do
            {
                if (user == User.customer)
                {
                    ...
                    if (optionToInt >= 1 && optionToInt <= 5)
                    {
                        ...
                        if (snacks.quantity[optionToInt - 1] == 0)
                        {
                        ...
                        else
                        {
                            ...
                            if (sum >= snacks.price[optionToInt - 1])
                            {
                                double difference = sum - snacks.price[optionToInt - 1];
                                if (machine.GiveChange(difference, changePool, cashInserted))
                                {
                                    // then and only then reduce quantity
                                    snacks.quantity[optionToInt - 1] -= 1;
                                }
                                else
                                {
        ...
        public void Header(Snack snacks)
        {
            Console.WriteLine("#################################");
            ...
            for (int i = 0; i < snacks.label.Count(); i++)
            {
                if (snacks.quantity[i] > 0)
                {
                    Console.WriteLine((i + 1) + ". " + snacks.label[i] + customPadding[i] + "-- " + "£" + snacks.price[i].ToString("0.00") + "  --  " + snacks.quantity[i].ToString("D2"));
                }
                else
                {
                    Console.WriteLine((i + 1) + ". " + snacks.label[i] + customPadding[i] + "-- " + "£" + snacks.price[i].ToString("0.00") + "  --  " + "outOfStock");
                }
            }
        ...
        public void ChangePrices(Snack snacks)
        {
            ...
            while (newprice <= 0)
            {
                Console.WriteLine("change price for: " + snacks.label[id - 1]);
                newprice = Convert.ToDouble(Console.ReadLine());
            }
            snacks.price[id - 1] = newprice;
        }
        ...
        public void Quit(Snack snacks, Dictionary<double, int> coins, string dbfile, string dbfile2)
        {
